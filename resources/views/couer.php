        ...
        <div class="row" style="text-align: center;">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <!-- 下面這個是HTML的表格 -->
                    <tr>
                        <td style="width: 51px;" rowspan="3">第01節</td>
                    ...
                    <tr>
                        <td style="width: 51px;" rowspan="3">第02節</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                    ...
                    <tr>
                        <td style="width: 51px;" rowspan="3">第03節</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                    ...
                    <tr>
                        <td style="width: 51px;" rowspan="3">第04節</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                    ...
                    <tr>
                        <td style="width: 51px;" rowspan="3">第05節</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                    ...
                    <tr>
                        <td style="width: 51px;" rowspan="3">第06節</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
                        <td style="width: 15px;">&nbsp;</td>
